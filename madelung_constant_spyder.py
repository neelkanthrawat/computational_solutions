...
"""
#this program is to evaluate the madelung constant of fcc and sc ionic crystals
#not finished yet
import numpy as np
...
#(1) all i need to do now is to count the number of elements of given value and evaluate the series of madelung constant
